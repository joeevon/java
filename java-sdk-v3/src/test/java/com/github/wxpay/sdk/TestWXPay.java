...
public class TestWXPay {
    ...
    public TestWXPay() throws Exception {
        ...
        out_trade_no = "201613091059590000003433-asd005";
    }
    ...
    public void doUnifiedOrder() {
        ...
        data.put("appid","wx7d69cc6664fea758");
        data.put("openid","ox7yi0eL30iBqtitkXjOVJ-woDgs");
        data.put("body", "yiaiteach-pay-test");
